...
Calendar View
    ...
    |
    Select Date --> Date Picker (Jump to date)
    |
    v
Day Detail
...
```
+---------------------------+
| FoodBytes           [=]   | <- Header (hamburger + profile)
+---------------------------+
|                           |
| +----------------------+  |
...
|                           |
+---------------------------+
| Recipe  Plan  Search Shop | <- Bottom nav (thumb zone)
+---------------------------+
```
